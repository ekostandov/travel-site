...
var MobileMenu = function () {
	...
	_createClass(MobileMenu, [{
		...
		value: function toggleTheMenu() {
			this.menuContent.toggleClass('site-header__menu-content_is-visible');
			this.siteHeader.toggleClass('site-header_expanded');
			this.menuIcon.toggleClass('site-header__menu_close-x');
		}
	}]);
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						(0, _jquery2.default)(currentItem).addClass('reveal-item_is-visible');
					},
		...
		value: function createHeaderWaypoint() {
			...
			new Waypoint({
				...
				handler: function handler(direction) {
					if (direction == 'down') {
						that.siteHeader.addClass('site-header_dark');
					} else {
						that.siteHeader.removeClass('site-header_dark');
					}
				}
			});
		}
...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		value: function openModal() {
			this.modal.addClass('modal_is-visible');
			return false;
		}
	}, {
		key: 'closeModal',
		value: function closeModal() {
			this.modal.removeClass('modal_is-visible');
		}
	}]);
